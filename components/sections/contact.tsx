  ...
  return (
    <section id="contact" className="relative overflow-hidden py-24 md:py-32">
      ...
      <div className="mx-auto max-w-5xl px-5 lg:px-8">
        <Reveal className="rounded-[2rem] border border-white/20 bg-white/10 p-8 text-white backdrop-blur-xl md:p-14">
          ...
          <RevealGroup stagger={0.1} delay={0.2} className="mt-10 grid gap-4 md:grid-cols-3">
            <RevealItem>
              <a
